...
class ContactCompaniesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $contacts = \App\Contact::where('company_id', $id)->get();$listaexternas = \App\Listaexterna::where('proveedor_id', $id)->get();

        $contact_company = ContactCompany::findOrFail($id);

        return view('admin.contact_companies.show', compact('contact_company', 'contacts', 'listaexternas'));
    }
